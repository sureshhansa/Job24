...
define('DB_NAME', 'jobupdate_job24in');
define('DB_USER', 'jobupdate_job24in');
...
define('REMOTE_COUNTRIES', [
    ...
    'Australia', 'Germany', 'United Arab Emirates', 'Singapore', 'Ireland', 'Worldwide',
]);
...
define('CURRENCIES', [
    ...
    'GBP' => ['symbol' => '£', 'label' => 'Pound Sterling (£)', 'grouping' => 'western'],
]);
