...
$publishedAt = !empty($job['published_at']) ? date('Y-m-d', strtotime($job['published_at'])) : date('Y-m-d', strtotime($job['created_at']));
                    ...
                    <?php if ($job['apply_type'] === 'external'): ?>
                        ...
                        <a href="<?= e(url('go/' . $job['id'])) ?>" target="_blank" rel="noopener"
                           class="btn btn-primary w-100">
                            Apply Externally <i class="bi bi-box-arrow-up-right"></i>
                        </a>
